	...
	for(var i in data){
		...
		htmlstr += 
			'<div class = "row resultDiv">'+
				...
				'</span><a href = "../html/ticket.html?eventId='+eventId+'" style = "color:#008000;position:absolute;top:60px;left:-300%;font-size:14px;" target="_blank">http://www.ggkbigdata.com/</a><span style = "behavior:url(/js/ie-css3.htc);background:#24C0D7!important;border-radios:5px;border-radius:5px;color:#fff;padding:1px 5px;position:absolute;top:47px;right:0px;font-size:16px;display:inline-block;">'+commitTime.substr(0,10)+'</span>'+
