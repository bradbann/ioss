...
public interface DataSynchronismMapper {
    public List<TicketMainInfo> getTicketMainInfoFromOral(@Param("startDate") long startDate,@Param("endDate") long endDate, @Param("start") long start, @Param("end") long end);
